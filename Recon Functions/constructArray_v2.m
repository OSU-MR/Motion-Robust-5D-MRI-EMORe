function [ResCol,ResLin,ResPar,Rate_s,Rate_w,NImageCols,NImageLins,NImagePars] = constructArray_v2(FlowSG4D_Outputs, opt, name, saveLocation, param, raw_header,acq_param)
