...
[R, C,PCIC, respRange] = extractMotionSignals(SG,opt);
...
[cBins(1,1,:), param.meanRR, param.stdRR, param.triggerTime, triggers] = binCardiacPhases(lengthDat, C,PCIC, opt);
...
figure;
subplot(211); 
plot(opt.timeFull, opt.resp_full);
...
xlabel("Time");
savefig('RespCard.fig');
saveas(gcf,'Respcard.jpg');
% *******************************************************
...
[rWeights(1,1,:,:), respEfficiency] = binRespSoft_v2(lengthDat, R, opt, param);
