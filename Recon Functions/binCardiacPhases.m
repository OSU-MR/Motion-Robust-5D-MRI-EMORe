function [cBins, meanRR, stdRR, triggerTime, triggers,C] = binCardiacPhases(lengthDat,C,TR,nCPhases,SG_freq,binOffset)
...
figure;
plot(timeSG, C_interp); hold on; plot(timePeaks_true, trigger_pks, '.r');
xlabel("Time");
ylabel("Triggers");
