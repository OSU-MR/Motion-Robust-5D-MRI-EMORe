function [cBins, meanRR, stdRR, triggerTime, triggers] = binCardiacPhases1(lengthDat,C,TR,arrhyRej,nCPhases,SG_freq,binOffset)
...
% Time
timeSG = [1:1:length(C)]*TR*(1/interp_factor); %What is interp factor?
...
tmp = [0:1:length(C)-1]*TR*(1/interp_factor);
